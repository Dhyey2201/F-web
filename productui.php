...
<body class="bg-gray-100 py-10">
  ...
  <div class="max-w-2xl mx-auto bg-white p-8 rounded-xl shadow-md">
    ...
    <form action="<?='http://192.168.1.170/api/product/proin' ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
			<div>
        <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Products brand Name</label>
        <input type="text" name="pro_brand" id="name" class="w-full border-gray-300 rounded-lg shadow-sm p-3 focus:ring-blue-500 focus:border-blue-500" required>
      </div>
     
      <div>
        <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Products Name</label>
        <input type="text" name="pro_name" id="name" class="w-full border-gray-300 rounded-lg shadow-sm p-3 focus:ring-blue-500 focus:border-blue-500" required>
      </div>
			<div>
        <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Products discription</label>
        <input type="text" name="pro_discription" id="name" class="w-full border-gray-300 rounded-lg shadow-sm p-3 focus:ring-blue-500 focus:border-blue-500" required>
      </div>
     
	  	<div>
        <label for="description" class="block text-sm font-medium text-gray-700 mb-1">Category id</label>
        <input name="co-id" id="description" rows="4" class="w-full border-gray-300 rounded-lg shadow-sm p-3 focus:ring-blue-500 focus:border-blue-500" required></>
      </div>
			<div>
        <label for="description" class="block text-sm font-medium text-gray-700 mb-1">SubCategory id</label>
        <input name="sc_id" id="description" rows="4" class="w-full border-gray-300 rounded-lg shadow-sm p-3 focus:ring-blue-500 focus:border-blue-500" required></>
      </div>
			<div>
        <label for="description" class="block text-sm font-medium text-gray-700 mb-1">product price</label>
        <input name="pro_price" id="description" rows="4" class="w-full border-gray-300 rounded-lg shadow-sm p-3 focus:ring-blue-500 focus:border-blue-500" required></>
      </div>
			<div>
        <label for="description" class="block text-sm font-medium text-gray-700 mb-1">product Size</label>
        <input name="pro_size" id="size" rows="4" class="w-full border-gray-300 rounded-lg shadow-sm p-3 focus:ring-blue-500 focus:border-blue-500" required></>
      </div>
